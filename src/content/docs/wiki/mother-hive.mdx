...
[naming-decisions](./naming-decisions) (`usb_nodes → hive_nodes` row)
...
→ [naming-decisions](./naming-decisions) ("Known residue"), clawdie-iso #133
...
- [agent-harness](./agent-harness) — the zot/Colibri split; autospawn
- [naming-decisions](./naming-decisions) — `usb_nodes → hive_nodes`, autospawn flag rename
- [quality-gates](./quality-gates) — the gate that should catch drift at PR time
