...
| Item                                 | Note                                                                                                    |
| ------------------------------------ | ------------------------------------------------------------------------------------------------------- |
| `ADR-agent-harness-consolidation.md` | Referenced but does not exist; `AGENTS.md` is the real anchor. See [agent-harness](./agent-harness). |
...
- [quality-gates](./quality-gates) — the gate that should catch these at PR time
