...
- [store-schema](./store-schema) — coordination and planned skill catalog tables
- [operator-cli](./operator-cli) — planned skill catalog CLI commands
- [task-board](./task-board) — agents will match claimed tasks to skills by capability
