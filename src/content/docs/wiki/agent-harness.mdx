...
- Wire format: [agent-events-reference](./agent-events-reference)
...
- [task-dispatch-flow](./task-dispatch-flow) — the full submit → done chain
- [naming-decisions](./naming-decisions) — harness naming history
- [hive-routing](./hive-routing) — capability-based task dispatch
