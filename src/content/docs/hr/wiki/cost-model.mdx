...
- [deepseek-pricing](./deepseek-pricing) — per-token pricing table with peak-valley rates
- [task-board](./task-board) — the scheduler that dispatches tasks within session budgets
- [contracts](./contracts) — TaskCostSummary schema v1
- [mother-hive](./mother-hive) — MCP architecture (different cost domain)
- [quality-gates](./quality-gates) — the gate that validates cost-mode parsing
