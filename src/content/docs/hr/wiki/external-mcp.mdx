...
See [jail-confinement](./jail-confinement).
...
- [jail-confinement](./jail-confinement) — jail policy reused for external MCP servers
- [cost-model](./cost-model) — cost mode and the write-gated `colibri_set_cost_mode`
- [skills-catalog](./skills-catalog) — read-only skill catalog exposed via `colibri_list_skills`
