...
| Tools             | MCP servers (see [external-mcp](./external-mcp.md))    |
...
See [agent-harness](./agent-harness.md) for the zot/Colibri split,
[doctor](./doctor.md) for the self-diagnosis battery, and
[task-dispatch-flow](./task-dispatch-flow.md) for the end-to-end task path.
...
the daemon from source when the binary is stale. See [doctor](./doctor.md).
...
with FTS5 search is the catalog. See [skills-catalog](./skills-catalog.md).
...
in Colibri. See [model-selection-and-eval](./model-selection-and-eval.md) for
...
- [agent-harness](./agent-harness.md) — zot/Colibri split
- [task-dispatch-flow](./task-dispatch-flow.md) — end-to-end task path
- [model-selection-and-eval](./model-selection-and-eval.md) — eval harness + model routing
- [doctor](./doctor.md) — self-diagnosis battery
- [cost-model](./cost-model.md) — token economics
