...
- [task-board](./task-board) — local task board (data source for cost capture)
- [hive-pane](./hive-pane) — hive board (companion surface, node status)
- [hive-routing](./hive-routing) — cost-aware routing engine (consumes this data)
